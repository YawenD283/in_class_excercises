...
df_subset <- df.diamonds[1:10000, ]

ggplot(data = df_subset, aes(x = cut, y = price)) +
  geom_violin(fill = "white", color = "black", adjust = 1) +
  geom_jitter(alpha = 0.2, width = 0.1, size = 1, color = "black") + 
