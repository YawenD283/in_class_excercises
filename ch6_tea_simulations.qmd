...
tea_data_summary
```
When the sample size increases, I do see some changes in the estimation of mean difference, but it is hard to tell the patterns of changing. 
...
```
When n_total = 96, the estimates are more consistent, and should be closer to the true population mean difference. 
